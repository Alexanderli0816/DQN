...
class ReplayMemory:
    ...
    def getState(self, index):
        assert self.count > 0 and index <= self.count, "replay memory is emtpy or query out-of-boundary index"
    ...
    def sample(self):
        ...
        while len(indexes) < self.batch_size:
            ...
            while True:
                ...
                # if wraps over current pointer or wraps over episode end, then get new one
